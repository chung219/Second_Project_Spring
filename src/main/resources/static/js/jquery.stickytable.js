jQuery(document).on('stickyTable', function() {
    ...
    if(positionStickySupport) {
        ...
        $(".sticky-table").each( function () {
            ...
            offset = 0;
            $($(this).find(".paging").get().reverse()).each( function () {
        ...
        $(".view_wrap").each( function () {
            offset = 0;
            $(this).find(".btn_area_top").each( function () {
                $(this).css('top', offset);
                offset += $(this).outerHeight();
            })
        })
    ...
    if($(".sticky-rtl-cells",".view_wrap").length && !(positionStickySupport && scrollTypeRTL == 'negative')) {
        if(positionStickySupport) {
            ...
            $(".view_wrap .btn_area_top").css('position', "relative");
            $(".view_wrap").scroll(function() {
                $(this).find(".btn_area_top").css('top', $(this).scrollTop());
            }).scroll();
            $(".sticky-table").scroll(function() {
                ...
                //$(this).find(".paging").css('bottom', maxScroll - $(this).scrollTop());
            }).scroll();
        }
